<#
	...
	.\WindowsPowerShell\Modules\InfrastructureAsCode.Powershell.HowToExtend\script-configure-provision.ps1 -RelativeOrFullPath "C:\Users\sleonard.CONTOSO\Documents\SampleDefinitions"
#>  
