			...
			<td>
				<table border="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td width="400px" valign="top" class="ms-formbody">
							<xsl:value-of select="@SampleCSRDescAttachments" disable-output-escaping="yes"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<xsl:value-of select="@SampleCSRCoverLetterAttachments" disable-output-escaping="yes"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<xsl:value-of select="@SampleCSRSecondaryAttachments" disable-output-escaping="yes"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
