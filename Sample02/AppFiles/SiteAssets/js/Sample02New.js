...
function PreSaveAction() {
    ...
    // otherwise set form fields before it is saved
    var formattedDate = (new Date(lastUpdated)).toISOString();
    console.log(String.format("Formatted Date is {0}", formattedDate));

    jQuery("Input[Title='Title Required Field']").val(String.format("Database Sample - {0}", formattedDate));
