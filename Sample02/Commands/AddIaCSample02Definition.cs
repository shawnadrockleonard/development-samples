...
namespace InfrastructureAsCode.Powershell.Sample02.Commands
{
    [Cmdlet(VerbsCommon.Add, "IaCSample02Definition")]
    [CmdletHelp("Returns a report of the entire farm", Category = "Reporting")]
    public class AddIaCSample02Definition : IaCCmdlet
    {
