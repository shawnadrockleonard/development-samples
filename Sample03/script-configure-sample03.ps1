<#
	...
	Example
		...
		$RelativeOrFullPath = Full Path to your Project Folder c:\[YOUR REPO FOLDER]\development-samples\Sample03\AppFiles\

	.\WindowsPowerShell\Modules\InfrastructureAsCode.Powershell.Sample03\script-configure-sample03.ps1 -RelativeOrFullPath $RelativeOrFullPath
#>  
