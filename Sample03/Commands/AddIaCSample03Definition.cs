...
using InfrastructureAsCode.Powershell.Sample03.Models;
...
namespace InfrastructureAsCode.Powershell.Sample03.Commands
{
    [Cmdlet(VerbsCommon.Add, "IaCSample03Definition")]
    [CmdletHelp("Returns a report of the entire farm", Category = "Reporting")]
    public class AddIaCSample03Definition : IaCCmdlet
    {
