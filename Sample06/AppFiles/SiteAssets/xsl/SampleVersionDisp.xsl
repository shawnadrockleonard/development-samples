      ...
      <td>
        <table border="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td width="400px" valign="top" class="ms-formbody">
              <xsl:value-of select="@My_x0020_Notes" disable-output-escaping="yes"/>
            </td>
          </tr>
          <tr>
            <td width="190px" valign="top" class="ms-formlabel">
              <H3 class="ms-standardheader">
                <nobr>My Notes (appended)</nobr>
              </H3>
            </td>
            <td width="400px" valign="top" class="ms-formbody">
              <SharePoint:AppendOnlyHistory runat="server" FieldName="My_x0020_Notes" ControlMode="Display" ItemId="{@ID}"/>
            </td>
          </tr>
          <tr>
            <td width="190px" valign="top" class="ms-formlabel">
              <H3 class="ms-standardheader">
                <nobr>My Notes (REST API)</nobr>
              </H3>
            </td>
            <td width="400px" valign="top" class="ms-formbody">
              <div id="myNotesAppended"></div>
            </td>
          </tr>
          <tr>
            <td width="190px" valign="top" class="ms-formlabel">
            ...
            <td width="400px" valign="top" class="ms-formbody">
              <xsl:value-of select="@My_x0020_Choice"/>
            </td>
          </tr>
